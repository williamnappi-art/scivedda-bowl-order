...
const MENU_CATEGORIES = {
  basi: {
    ...
    color: "#f5e6d3",
    items: [
      { id: "fregola", name: "Fregula Sarda", cal: 150, icon: "🟤", cardImage: "/basi-fregola.webp" },
      { id: "riso-bianco", name: "Riso Bianco di Oristano", cal: 130, icon: "🍚", cardImage: "/basi-riso-bianco.webp" },
      { id: "riso-rosso", name: "Riso Rosso Integrale di Oristano", cal: 125, icon: "🔴", cardImage: "/basi-riso-rosso.webp" },
      { id: "riso-nero", name: "Riso Nero Integrale di Oristano", cal: 120, icon: "⚫", cardImage: "/basi-riso-nero.webp" },
      { id: "farro", name: "Farro di Sardegna", cal: 140, icon: "🌾", cardImage: "/basi-farro.webp" },
      { id: "insalata", name: "Insalata di Stagione", cal: 20, icon: "🥬", cardImage: "/basi-insalata.webp" },
      { id: "riso-insalata", name: "Riso + Insalata", cal: 90, icon: "🍱", cardImage: "/basi-riso-insalata.webp" },
      { id: "fregola-insalata", name: "Fregula + Insalata", cal: 95, icon: "🥗", cardImage: "/basi-fregola-insalata.webp" },
    ],
  },
  proteine: {
    label: "Proteina",
  ...
  verdure: {
    ...
    items: [
      ...
      { id: "cipolla-rossa",     name: "Cipolla Rossa",        cal: 10,  icon: "🧅", cardImage: "/verdure-cipolla-rossa.webp" },
      { id: "olive-parteolla",   name: "Olive del Parteolla",  cal: 40,  icon: "🫒" },
      { id: "cetriolo",          name: "Cetriolo",             cal: 15,  icon: "🥒" },
      { id: "frutta-stagione",   name: "Frutta di Stagione",   cal: 50,  icon: "🍓", cardImage: "/verdure-frutta-stagione.webp" },
      { id: "pomodorini-pula",   name: "Pomodorini di Pula",   cal: 18,  icon: "🍅", cardImage: "/verdure-pomodorini.webp" },
      { id: "edamame",           name: "Edamame",              cal: 120, icon: "🫛" },
      { id: "ananas",            name: "Ananas",               cal: 40,  icon: "🍍" },
      { id: "mais",              name: "Mais",                 cal: 35,  icon: "🌽" },
      { id: "jalapeno",          name: "Jalapeño",             cal: 5,   icon: "🌶️", cardImage: "/verdure-jalapeno.webp" },
      { id: "mango",             name: "Mango",                cal: 60,  icon: "🥭", extra: 1 },
      { id: "carote",            name: "Carote",               cal: 20,  icon: "🥕", cardImage: "/verdure-carote.webp" },
      ...
      { id: "finocchio",         name: "Finocchio",            cal: 20,  icon: "🌿", cardImage: "/verdure-finocchio.webp" },
      { id: "verdura-stagione",  name: "Verdura di Stagione",  cal: 30,  icon: "🥦", extra: 1.5, cardImage: "/verdure-verdura-stagione.webp" },
      ...
      <div style={{ minHeight: "100vh", background: theme.bg }}>
        ...
        <div style={{ padding: 16 }}>
          ...
          <button onClick={sendOrder} disabled={!customerName.trim() || !diningOption || sending} style={{
            ...
            background: customerName.trim() && diningOption && !sending ? "linear-gradient(135deg, #25d366, #128c7e)" : "#ccc",
            border: "none", borderRadius: 14,
            color: "#fff", fontSize: 16, fontWeight: 700,
            cursor: customerName.trim() && !sending ? "pointer" : "not-allowed", fontFamily: "inherit",
            display: "flex", alignItems: "center", justifyContent: "center", gap: 10,
            boxShadow: customerName.trim() && !sending ? "0 4px 20px rgba(37,211,102,0.35)" : "none",
