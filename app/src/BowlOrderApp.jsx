...
const getMenuCategories = (t) => ({
  basi: {
    ...
    color: "#f5e6d3",
    items: [
      { id: "fregola",          name: t("builder.fregola_name"),          cal: 150, icon: "🟤", cardImage: "/card-fregula.webp" },
  ...
  proteine: {
    ...
    items: [
      ...
      { id: "gambero-cotto",       name: t("builder.gambero-cotto_name"),       cal: 100, icon: "🦐", extra: 2, cardImage: "/card-gamberi-cotti.webp" },
      { id: "polpo",               name: t("builder.polpo_name"),               cal: 120, icon: "🐙", extra: 3, cardImage: "/card-polpo.webp" },
      { id: "uovo-pula",           name: t("builder.uovo-pula_name"),           cal: 90,  icon: "🥚", cardImage: "/card-uovo-di-pula.webp" },
      { id: "maiale-sfilacciato",  name: t("builder.maiale-sfilacciato_name"),  cal: 200, icon: "🥩", extra: 3, cardImage: "/card-maiale-sfilacciato.webp" },
      { id: "polletto",            name: t("builder.polletto_name"),            cal: 170, icon: "🍗", cardImage: "/card-polletto-ruspante.webp" },
      { id: "tofu-naturale",       name: t("builder.tofu-naturale_name"),       cal: 90,  icon: "🧈", cardImage: "/card-tofu.webp" },
      { id: "legumi",              name: t("builder.legumi_name"),              cal: 130, icon: "🫘", cardImage: "/card-legumi-misti.webp" },
    ],
  },
  verdure: {
    ...
    color: "#d4edda",
    items: [
      { id: "avocado",          name: t("builder.avocado_name"),          cal: 80,  icon: "🥑", extra: 1.5, cardImage: "/card-avocado.webp" },
      { id: "cipolla-rossa",    name: t("builder.cipolla-rossa_name"),    cal: 10,  icon: "🧅", cardImage: "/card-cipolla-rossa.webp" },
      { id: "olive-parteolla",  name: t("builder.olive-parteolla_name"),  cal: 40,  icon: "🫒", cardImage: "/card-olive-del-parteolla.webp" },
      { id: "cetriolo",         name: t("builder.cetriolo_name"),         cal: 15,  icon: "🥒", cardImage: "/card-cetriolo.webp" },
      { id: "frutta-stagione",  name: t("builder.frutta-stagione_name"),  cal: 50,  icon: "🍓", cardImage: "/card-frutta-di-stagione.webp" },
      { id: "pomodorini-pula",  name: t("builder.pomodorini-pula_name"),  cal: 18,  icon: "🍅", cardImage: "/card-pomodorini-di-pula.webp" },
      { id: "edamame",          name: t("builder.edamame_name"),          cal: 120, icon: "🫛", cardImage: "/card-edamame.webp" },
      { id: "ananas",           name: t("builder.ananas_name"),           cal: 40,  icon: "🍍", cardImage: "/card-ananas.webp" },
      { id: "mais",             name: t("builder.mais_name"),             cal: 35,  icon: "🌽", cardImage: "/card-mais.webp" },
      { id: "jalapeno",         name: t("builder.jalapeno_name"),         cal: 5,   icon: "🌶️", cardImage: "/card-jalapeno.webp" },
      { id: "mango",            name: t("builder.mango_name"),            cal: 60,  icon: "🥭", extra: 1, cardImage: "/card-mango.webp" },
      { id: "carote",           name: t("builder.carote_name"),           cal: 20,  icon: "🥕", cardImage: "/card-carote.webp" },
      { id: "ceci",             name: t("builder.ceci_name"),             cal: 130, icon: "🫘", cardImage: "/card-ceci.webp" },
      { id: "zucchina-fritta",  name: t("builder.zucchina-fritta_name"),  cal: 70,  icon: "🥬", extra: 1.5, cardImage: "/card-zucchina-fritta.webp" },
      ...
      { id: "pomodoro-secco",   name: t("builder.pomodoro-secco_name"),   cal: 45,  icon: "🔴", cardImage: "/card-pomodoro-secco.webp" },
    ],
  },
  croccanti: {
